...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile = $(bin)$(G2K2Pi4Alg_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_G2K2Pi4Algsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_G2K2Pi4Algsetup.make
else
#cmt_local_setup = $(bin)G2K2Pi4Algsetup$(cmt_lock_pid).make
...
G2K2Pi4Alg_extratags = -tag_add=target_G2K2Pi4Alg

#$(cmt_local_tagfile_G2K2Pi4Alg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_G2K2Pi4Alg) ::
else
$(cmt_local_tagfile_G2K2Pi4Alg) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_G2K2Pi4Alg)"
	@if test -f $(cmt_local_tagfile_G2K2Pi4Alg); then /bin/rm -f $(cmt_local_tagfile_G2K2Pi4Alg); fi ; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_extratags) build tag_makefile >>$(cmt_local_tagfile_G2K2Pi4Alg); \
	  if test -f $(cmt_final_setup_G2K2Pi4Alg); then /bin/rm -f $(cmt_final_setup_G2K2Pi4Alg); fi; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_extratags) show setup >>$(cmt_final_setup_G2K2Pi4Alg)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_G2K2Pi4Alg_makefile) :: $(G2K2Pi4Alg_dependencies) $(cmt_local_tagfile_G2K2Pi4Alg) build_library_links dirs
else
$(cmt_local_G2K2Pi4Alg_makefile) :: $(cmt_local_tagfile_G2K2Pi4Alg)
endif
	$(echo) "(constituents.make) Building G2K2Pi4Alg.make"; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_extratags) build constituent_makefile -out=$(cmt_local_G2K2Pi4Alg_makefile) G2K2Pi4Alg

G2K2Pi4Alg :: $(G2K2Pi4Alg_dependencies) $(cmt_local_G2K2Pi4Alg_makefile)
	$(echo) "(constituents.make) Starting G2K2Pi4Alg"
	@$(MAKE) -f $(cmt_local_G2K2Pi4Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} G2K2Pi4Alg
	$(echo) "(constituents.make) G2K2Pi4Alg done"

clean :: G2K2Pi4Algclean

G2K2Pi4Algclean :: $(G2K2Pi4Algclean_dependencies) ##$(cmt_local_G2K2Pi4Alg_makefile)
	$(echo) "(constituents.make) Starting G2K2Pi4Algclean"
	@-if test -f $(cmt_local_G2K2Pi4Alg_makefile); then \
	  $(MAKE) -f $(cmt_local_G2K2Pi4Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} G2K2Pi4Algclean; \
	fi

##	  /bin/rm -f $(cmt_local_G2K2Pi4Alg_makefile) $(bin)G2K2Pi4Alg_dependencies.make

install :: G2K2Pi4Alginstall

G2K2Pi4Alginstall :: $(G2K2Pi4Alg_dependencies) $(cmt_local_G2K2Pi4Alg_makefile)
	$(echo) "(constituents.make) Starting install G2K2Pi4Alg"
	@-$(MAKE) -f $(cmt_local_G2K2Pi4Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install G2K2Pi4Alg done"

uninstall :: G2K2Pi4Alguninstall

G2K2Pi4Alguninstall :: $(cmt_local_G2K2Pi4Alg_makefile)
	$(echo) "(constituents.make) Starting uninstall G2K2Pi4Alg"
	@-$(MAKE) -f $(cmt_local_G2K2Pi4Alg_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall G2K2Pi4Alg done"
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag)_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_G2K2Pi4Alg_install_runtimesetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_runtime = $(G2K2Pi4Alg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(G2K2Pi4Alg_tag)_install_runtime.make
cmt_final_setup_install_runtime = $(bin)G2K2Pi4Alg_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_runtime = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_install_runtime = $(bin)G2K2Pi4Algsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
endif
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(G2K2Pi4Alg_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_G2K2Pi4Alg_configsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(G2K2Pi4Alg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(G2K2Pi4Alg_tag)_config.make
cmt_final_setup_config = $(bin)G2K2Pi4Alg_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_config = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_config = $(bin)G2K2Pi4Algsetup.make
cmt_local_config_makefile = $(bin)config.make
endif
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(G2K2Pi4Alg_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_G2K2Pi4Alg_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(G2K2Pi4Alg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(G2K2Pi4Alg_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)G2K2Pi4Alg_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_install_includes = $(bin)G2K2Pi4Algsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(G2K2Pi4Alg_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_G2K2Pi4Alg_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(G2K2Pi4Alg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(G2K2Pi4Alg_tag)_make.make
cmt_final_setup_make = $(bin)G2K2Pi4Alg_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_make = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_make = $(bin)G2K2Pi4Algsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(G2K2Pi4Alg_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_G2K2Pi4Alg_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(G2K2Pi4Alg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(G2K2Pi4Alg_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)G2K2Pi4Alg_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_CompilePython = $(bin)G2K2Pi4Algsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(G2K2Pi4Alg_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_G2K2Pi4Alg_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(G2K2Pi4Alg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(G2K2Pi4Alg_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)G2K2Pi4Alg_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_qmtest_run = $(bin)G2K2Pi4Algsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(G2K2Pi4Alg_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_G2K2Pi4Alg_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(G2K2Pi4Alg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(G2K2Pi4Alg_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)G2K2Pi4Alg_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)G2K2Pi4Algsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(G2K2Pi4Alg_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_G2K2Pi4Alg_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(G2K2Pi4Alg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(G2K2Pi4Alg_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)G2K2Pi4Alg_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_TestPackage = $(bin)G2K2Pi4Algsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(G2K2Pi4Alg_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_G2K2Pi4Alg_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(G2K2Pi4Alg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(G2K2Pi4Alg_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)G2K2Pi4Alg_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_TestProject = $(bin)G2K2Pi4Algsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(G2K2Pi4Alg_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_G2K2Pi4Alg_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(G2K2Pi4Alg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(G2K2Pi4Alg_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)G2K2Pi4Alg_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_new_rootsys = $(bin)G2K2Pi4Algsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(G2K2Pi4Alg_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_G2K2Pi4Alg_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(G2K2Pi4Alg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(G2K2Pi4Alg_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)G2K2Pi4Alg_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)G2K2Pi4Algsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
...
ifdef READONLY
cmt_local_tagfile_EventNavigator_check_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag)_EventNavigator_check_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_EventNavigator_check_install_runtime = /tmp/CMT_G2K2Pi4Alg_EventNavigator_check_install_runtimesetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = /tmp/CMT_EventNavigator_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(G2K2Pi4Alg_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(G2K2Pi4Alg_tag)_EventNavigator_check_install_runtime.make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)G2K2Pi4Alg_EventNavigator_check_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_EventNavigator_check_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_EventNavigator_check_install_runtime = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = /tmp/CMT_EventNavigator_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)G2K2Pi4Algsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
endif
...
cmt_G2K2Pi4Alg_check_install_runtime_has_target_tag = 1

#--------------------------------------------------------

ifdef cmt_G2K2Pi4Alg_check_install_runtime_has_target_tag

ifdef READONLY
cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag)_G2K2Pi4Alg_check_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_G2K2Pi4Alg_check_install_runtime = /tmp/CMT_G2K2Pi4Alg_G2K2Pi4Alg_check_install_runtimesetup.make
cmt_local_G2K2Pi4Alg_check_install_runtime_makefile = /tmp/CMT_G2K2Pi4Alg_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = $(G2K2Pi4Alg_tag)_G2K2Pi4Alg_check_install_runtime.make
cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = $(bin)$(G2K2Pi4Alg_tag)_G2K2Pi4Alg_check_install_runtime.make
cmt_final_setup_G2K2Pi4Alg_check_install_runtime = $(bin)G2K2Pi4Alg_G2K2Pi4Alg_check_install_runtimesetup.make
cmt_local_G2K2Pi4Alg_check_install_runtime_makefile = $(bin)G2K2Pi4Alg_check_install_runtime.make
endif

G2K2Pi4Alg_check_install_runtime_extratags = -tag_add=target_G2K2Pi4Alg_check_install_runtime

#$(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime) ::
else
$(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime); \
	  if test -f $(cmt_final_setup_G2K2Pi4Alg_check_install_runtime); then /bin/rm -f $(cmt_final_setup_G2K2Pi4Alg_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_check_install_runtime_extratags) show setup >>$(cmt_final_setup_G2K2Pi4Alg_check_install_runtime)
	$(echo) setup.make ok

else

ifdef READONLY
cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = /tmp/CMT_$(G2K2Pi4Alg_tag).make$(cmt_lock_pid)
cmt_final_setup_G2K2Pi4Alg_check_install_runtime = /tmp/CMT_G2K2Pi4Algsetup.make
cmt_local_G2K2Pi4Alg_check_install_runtime_makefile = /tmp/CMT_G2K2Pi4Alg_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = $(G2K2Pi4Alg_tag).make
cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime = $(bin)$(G2K2Pi4Alg_tag).make
cmt_final_setup_G2K2Pi4Alg_check_install_runtime = $(bin)G2K2Pi4Algsetup.make
cmt_local_G2K2Pi4Alg_check_install_runtime_makefile = $(bin)G2K2Pi4Alg_check_install_runtime.make
endif
...
ifndef QUICK
$(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) :: $(G2K2Pi4Alg_check_install_runtime_dependencies) $(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime) build_library_links dirs
else
$(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) :: $(cmt_local_tagfile_G2K2Pi4Alg_check_install_runtime)
endif
	$(echo) "(constituents.make) Building G2K2Pi4Alg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(G2K2Pi4Alg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) G2K2Pi4Alg_check_install_runtime

G2K2Pi4Alg_check_install_runtime :: $(G2K2Pi4Alg_check_install_runtime_dependencies) $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating G2K2Pi4Alg_check_install_runtime${lock_suffix} and Starting G2K2Pi4Alg_check_install_runtime"
	@${lock_command} G2K2Pi4Alg_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} G2K2Pi4Alg_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} G2K2Pi4Alg_check_install_runtime; \
	  retval=$$?; ${unlock_command} G2K2Pi4Alg_check_install_runtime${lock_suffix}; exit $${retval}
	$(echo) "(constituents.make) G2K2Pi4Alg_check_install_runtime done"

clean :: G2K2Pi4Alg_check_install_runtimeclean

G2K2Pi4Alg_check_install_runtimeclean :: $(G2K2Pi4Alg_check_install_runtimeclean_dependencies) ##$(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting G2K2Pi4Alg_check_install_runtimeclean"
	@-if test -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} G2K2Pi4Alg_check_install_runtimeclean; \
	fi

##	  /bin/rm -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) $(bin)G2K2Pi4Alg_check_install_runtime_dependencies.make

install :: G2K2Pi4Alg_check_install_runtimeinstall

G2K2Pi4Alg_check_install_runtimeinstall :: $(G2K2Pi4Alg_check_install_runtime_dependencies) $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install G2K2Pi4Alg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install G2K2Pi4Alg_check_install_runtime done"

uninstall :: G2K2Pi4Alg_check_install_runtimeuninstall

G2K2Pi4Alg_check_install_runtimeuninstall :: $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall G2K2Pi4Alg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_G2K2Pi4Alg_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall G2K2Pi4Alg_check_install_runtime done"

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ G2K2Pi4Alg_check_install_runtime"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ G2K2Pi4Alg_check_install_runtime done"
endif
