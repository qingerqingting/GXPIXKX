...
#
#   Generated Thu Jul 27 03:51:53 2017  by lvxd
#
#====================================
...
jobOptions_G2K2Pi4_txt_dependencies = ../share/jobOptions_G2K2Pi4.txt


install_runtimeinstall :: ${install_dir}/jobOptions_G2K2Pi4.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_G2K2Pi4.txt :: ../share/jobOptions_G2K2Pi4.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_G2K2Pi4.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_G2K2Pi4.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_G2K2Pi4.txt" "$(install_dir)" "cp -R" ; \
	fi
