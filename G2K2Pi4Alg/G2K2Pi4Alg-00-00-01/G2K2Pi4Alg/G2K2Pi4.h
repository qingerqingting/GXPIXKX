#ifndef Physics_Analysis_G2K2Pi4_H
#define Physics_Analysis_G2K2Pi4_H 
...
class G2K2Pi4 : public Algorithm {

	public:
		G2K2Pi4(const std::string& name, ISvcLocator* pSvcLocator);
	...
	private:
		...
		TLorentzVector *pip1_unfitted;
                TLorentzVector *pim1_unfitted;
