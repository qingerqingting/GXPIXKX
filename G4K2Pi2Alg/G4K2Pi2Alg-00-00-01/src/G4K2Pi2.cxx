...
/////////////////////////////////////////////////////////////////////////////
G4K2Pi2::G4K2Pi2(const std::string& name, ISvcLocator* pSvcLocator) :		//do not change this function
...
//**************************************
	...
	WTrackParameter wkp = vtxfit->wtrk(2);
        WTrackParameter wkm = vtxfit->wtrk(3);
...
//**************************************
	...
	Chisq_low=1000;
        ...
        for(int i1 = 0; i1 < nGamma-3; i1++){
		  ...
		  kmfit->AddTrack(4, wkp);
                  kmfit->AddTrack(5, wkm);
                  kmfit->AddTrack(6, 0.0, gammaTrk3);
                  kmfit->AddTrack(7, 0.0, gammaTrk4);
   		...
   		HepLorentzVector gamma1_ = kmfit->pfit(0);
                ...
                HepLorentzVector gamma4_ = kmfit->pfit(7);
                HepLorentzVector pip_ = kmfit->pfit(2);   
                HepLorentzVector pim_ = kmfit->pfit(3);  
		HepLorentzVector kp_ = kmfit->pfit(4);
                HepLorentzVector km_ = kmfit->pfit(5);
