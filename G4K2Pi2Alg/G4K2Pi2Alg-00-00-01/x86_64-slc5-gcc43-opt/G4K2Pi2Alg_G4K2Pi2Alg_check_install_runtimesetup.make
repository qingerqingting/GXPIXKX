...
use DatabaseSvc DatabaseSvc-00-00-19 Database (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4/)
...
lvxd_no_config (from PROJECT) excludes [lvxd_config]
lvxd_root (from PROJECT) excludes [lvxd_no_root]
lvxd_cleanup (from PROJECT) excludes [lvxd_no_cleanup]
lvxd_no_prototypes (from PROJECT) excludes [lvxd_prototypes]
lvxd_with_installarea (from PROJECT) excludes [lvxd_without_installarea]
lvxd_with_version_directory (from PROJECT) excludes [lvxd_without_version_directory]
lvxd (from PROJECT)
...
target_G4K2Pi2Alg_check_install_runtime (from arguments)
...
----------> CMTPATH
# Add path /besfs/users/lvxd/workarea from initialization
