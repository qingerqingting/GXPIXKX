...
#
#   Generated Sat Apr 16 00:03:49 2016  by lvxd
#
#====================================
...
jobOptions_G4K2Pi2_txt_dependencies = ../share/jobOptions_G4K2Pi2.txt


install_runtimeinstall :: ${install_dir}/jobOptions_G4K2Pi2.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_G4K2Pi2.txt :: ../share/jobOptions_G4K2Pi2.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_G4K2Pi2.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_G4K2Pi2.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_G4K2Pi2.txt" "$(install_dir)" "cp -R" ; \
	fi
