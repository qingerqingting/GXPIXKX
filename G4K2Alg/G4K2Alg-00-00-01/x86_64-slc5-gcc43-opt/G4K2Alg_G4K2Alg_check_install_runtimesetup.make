...
use McCor McCor-00-00-17 Analysis/PhotonCor (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
----------> tags
...
longyf_no_config (from PROJECT) excludes [longyf_config]
longyf_root (from PROJECT) excludes [longyf_no_root]
longyf_cleanup (from PROJECT) excludes [longyf_no_cleanup]
longyf_no_prototypes (from PROJECT) excludes [longyf_prototypes]
longyf_with_installarea (from PROJECT) excludes [longyf_without_installarea]
longyf_with_version_directory (from PROJECT) excludes [longyf_without_version_directory]
longyf (from PROJECT)
...
target_G4K2Alg_check_install_runtime (from arguments)
...
----------> CMTPATH
# Add path /besfs/users/longyf/workarea664p01 from initialization
