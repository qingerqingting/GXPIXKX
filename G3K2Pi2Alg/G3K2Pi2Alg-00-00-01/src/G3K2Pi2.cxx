...
/////////////////////////////////////////////////////////////////////////////
G3K2Pi2::G3K2Pi2(const std::string& name, ISvcLocator* pSvcLocator) :		//do not change this function
...
//*************************************
   ...
   //Emcshower: electron and photon    information about incident angle and deposited energy
	...
	if(nGamma < 3) return StatusCode::SUCCESS;
        if(nGamma > 5) return StatusCode::SUCCESS;
